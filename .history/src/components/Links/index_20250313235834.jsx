    ...
    return (
        <div className="flex px-32 justify-center">
            <ul className="flex flex-col gap-10">
                <li className="border-4 rounded-3xl w-228 px-12 py-8 :hover:transform-4 transform-">
                    <a
                ...
                <li className="border-4 rounded-3xl w-228 px-12 py-8 :hover:transform trans">
                    <a 
                    className="flex items-end gap-6"
                    target="_blank" 
                    href="https://www.instagram.com/coda.ce">
