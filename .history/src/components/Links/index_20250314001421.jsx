    ...
    return (
        <div className="flex px-32 justify-center max-lg:px-6">
            <ul className="flex flex-col gap-10">
                <li className="border-4 rounded-3xl w-228 px-12 py-8 hover:scale-105 transition-transform duration-200 max-lg:px-2 max-lg:w-">
                    <a
                ...
                <li className="border-4 rounded-3xl w-228 px-12 py-8 hover:scale-105 transition-transform duration-200 max-lg:px-2 max-lg:w-102">
                    <a 
                    className="flex items-end gap-6"
                    target="_blank" 
                    href="https://www.instagram.com/coda.ce">
