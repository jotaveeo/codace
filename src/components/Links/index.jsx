      ...
      <ul className="flex flex-col gap-10 py-4">
        ...
        >
          ...
          >
            ...
            <h1 className="text-4xl max-lg:text-xl">
              Siga nosso{" "}
              <strong className="text-(--primary-color)">Instagram</strong>
            </h1>
          </a>
        </motion.li>
        <motion.li
        ...
        >
          ...
          >
            ...
            <h1 className="text-4xl max-lg:text-xl">
              Faça parte da{" "}
              <strong className="text-(--primary-color)">Comunidade</strong>
            </h1>
          </a>
        </motion.li>
        <motion.li
        ...
        >
          ...
          >
            ...
            <h1 className="text-4xl max-lg:text-xl">
              ...
              <strong className="text-(--primary-color) max-lg:hidden">
                {" "}
                - FullStack
              </strong>
            </h1>
        ...
        >
          ...
          >
            <GithubOutlined className="text-5xl max-lg:text-3xl" />
            <h1 className="text-4xl max-lg:text-xl">Palestras</h1>
          </a>
        </motion.li>
      </ul>
    </div>
